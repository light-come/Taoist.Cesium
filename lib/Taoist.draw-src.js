 ...
 (function () {
    ...
    class PolylineDrawer {
                    ...
                    if(num > 2){
                        ...
                        _this.viewer.entities.add({
                            ...
                            label: {
                                scale: 1,
                                font: '16px Helvetica',
                                text: VMSDS.measure.disTance( _this.positions[_this.positions.length - 2], _this.positions[_this.positions.length - 3]) + "米",
            ...
            _this.drawHandler.setInputAction(function (event) {
                ...
                switch (_this.type) {
                    case "测量":
                        var num = _this.positions.length;
                        if(num > 1){
                            _this.tooltip.showAt(position,VMSDS.measure.disTance( _this.positions[_this.positions.length - 2], _this.positions[_this.positions.length - 1]) + "米");
                        }
        ...
        startModify() {
            ...
            _this.modifyHandler.setInputAction(function (event) {
                ...
                DynamicDraw.shapeDic[_this.objId] = _this.tempPositions;
                ...
                switch (_this.type) {
                    case "测量":
                        ...
                        if(num > 2){
                            ...
                            var textArea = VMSDS.measure.getArea(tempPoints).toFixed(5) + "平方公里";
    ...
    class RectangleDrawer {
        ...
        startModify() {
            ...
            _this.modifyHandler.setInputAction(function (event) {
                ...
                DynamicDraw.shapeDic[_this.objId] = _this.positions;
    ...
    class DynamicDrawer {
        ...
        drawPolyline(okHandler) {
            ...
            if (okHandler) {
                _this.polylineDrawer.startDrawPolyline(function (positions) {
                    ...
                    DynamicDraw.shapeDic[objId] = positions;
        ...
        showPolyline(objId) {
            var _this = this;
            var style = _this.options._style;
            var positions = DynamicDraw.shapeDic[objId];
        ...
        editPolyline(objId) {
            var _this = this;
            var oldPositions = DynamicDraw.shapeDic[objId];
