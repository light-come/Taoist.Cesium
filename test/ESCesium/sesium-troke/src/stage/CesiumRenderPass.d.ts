...
export default class CesiumRenderPass {
    ...
    constructor(options: {
        ...
        uniforms?: { [key: string]: boolean | number | Cesium.Matrix4 | Cesium.Cartesian2 | Cesium.Color | Cesium.Cartesian3 | Object/** Cesium.Texture */ | (() => (boolean | number | Cesium.Matrix4 | Cesium.Cartesian2 | Cesium.Color | Cesium.Cartesian3 | Object/** Cesium.Texture */)) }
        beforeUpdate?(scene: Cesium.Scene): void
        renderStateProcess?(renderState?: Object /**Cesium.RenderState */): void
    })
    /**
     ...
     *@example
     ...
     let uniforms={
      ...
      //...
     */
    readonly texture: Object/**Cesium.Texture */
    /**
     ...
     *@example
     ...
     let uniforms={
      ...
      //...
     */
    readonly depthTexture: Object/**Cesium.Texture */
    /**
     * 设置绑定的后期处理节点。必须绑定后期处理节点，否则渲染通道将不会被调用执行渲染工作，也无法获取depthTexture和exture。
     */
    stage: Object/**Cesium.PostProcessStage */
    clear(context: Object/**Cesium.Context */): void
    update(context: Object/**Cesium.Context */): void
}
