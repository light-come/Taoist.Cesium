...
*/
const Go = Taoist.Go = (viewer:Cesium.Viewer,mapPosition:any,e:any=null) =>{
 ...
 * @param options
 */
const add3DTiles = Taoist.add3DTiles = (viewer:Cesium.Viewer, options :any,Style: { color: any; show: any; }) =>  {
