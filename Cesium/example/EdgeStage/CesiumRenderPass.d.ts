...
import Sampler from "cesium/Source/Renderer/Sampler";
import RenderState from "cesium/Source/Renderer/RenderState";
import Context from "cesium/Source/Renderer/Context";
...
export default class CesiumRenderPass {
    constructor(options: {
        ...
        sampler?: Sampler//Cesium.Sampler Cesium.Texture
        viewportScale: {
            x: number
            y: number
            with: number
        ...
        uniforms?: { [key: string]: boolean | number | Cesium.Matrix4 | Cesium.Cartesian2 | Cesium.Color | Cesium.Cartesian3 | Texture | (() => (boolean | number | Cesium.Matrix4 | Cesium.Cartesian2 | Cesium.Color | Cesium.Cartesian3 | Texture)) }
        beforeUpdate?(scene: Cesium.Scene): void
        renderStateProcess?(renderState?: RenderState): void
    })
    /**
