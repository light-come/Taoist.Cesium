window.onload = () => {
  (function () {
    let _LEM = {};
    G.U.Get((WEBGL_DEBUG ? WEBGL_Local : WEBGL_Server) + "/AP11.json", function (data) {
      _LEM = data;
      init();
    });
    ...
    const Layer = {
      ...
      LEFT_CLICK: viewer => {
        G.BOLT.getPosition(viewer, function (p) {
        ...
        G.create3D(
          {
            ...
            success: function (_viewer) {
              ...
              let rp = { positions: [_LEM.EE.List], multiplier: 1 };
