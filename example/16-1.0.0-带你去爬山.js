...
function aMODEL() {
  if (true) {
    //资源全部加载后飞行 防止卡顿
    var state = false;
    var percent_state = false; //非b3dm加载不需要使用这个
    let model_index = 0;
    G.IA(
      function (start) {},
      function (end) {
  ...
  var tileset = G.aTiles(
    viewer,
    {
      type: "山体",
      url: (WEBGL_DEBUG ? WEBGL_Local : WEBGL_Server) + "/%E4%BA%BA%E7%89%A9%E7%8E%AF%E6%A8%A1%E5%9E%8B/%E7%8E%AF%E5%A2%83/%E5%87%8C%E5%8E%89%E7%9A%84%E5%B1%B1%E5%8C%BA%E7%99%BD%E8%86%9C/tileset/tileset.json",
      flyTo: true,
      heightOffset: 0,
      height: 80,
      style: {
